 ...
 */
public final class TestAcquisition {

    /***/
    private TestAcquisition() {
    }
     ...
     *            :
     */
    private static void testAcquisition(Model model) {
	// 準備
	model.setAutoSaveEnabled(true);
	model.setAutoSaveFolderPath(Paths.get("c:/"));

	// テスト実行
	model.acquisition.startAcquisition();
    }
}
