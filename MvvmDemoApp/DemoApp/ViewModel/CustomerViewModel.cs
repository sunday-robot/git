...
namespace DemoApp.ViewModel
{
    ...
    public class CustomerViewModel : WorkspaceViewModel, IDataErrorInfo
    {
        ...
        public string Email
        {
            ...
            set
            {
                if (value == _customer.EMailAddress)
                    return;
        ...
        public string CustomerType
        {
            ...
            set
            {
                ...
                base.RaisePropertyChangedEvent("CustomerType");

                // このViewModelは、文字列などで表現された顧客の種類を、CustomerのIsComparyプロパティに変換する方法を知っているので、
                // 
        ...
        public void Save()
        {
            ...
            base.RaisePropertyChangedEvent("DisplayName");
        }
