...
public final class HSV {
	 ...
	 * @return HSV
	 */
	public static HSV createFromRGB(int rgb) {
		int r = RGBUtility.red(rgb);
		int g = RGBUtility.green(rgb);
		int b = RGBUtility.blue(rgb);
	...
	public int toRGB8() {
		RGB rgb = toRGB();
		int r = roundToByte(rgb.r);
		int g = roundToByte(rgb.g);
		int b = roundToByte(rgb.b);
		return RGBUtility.rgb(r, g, b);
	}
