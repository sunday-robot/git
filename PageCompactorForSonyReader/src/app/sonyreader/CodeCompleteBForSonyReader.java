 ...
 * @author akiyama
 */
public class CodeCompleteBForSonyReader {
    /**
     * @param args
     *            画像ファイル名
     * @throws IOException
	...
	PageRegion body = new PageRegion(170, 560, 240, 1360, 2350);
	PageLayout originalPageLayout = new PageLayout(header, body, null);
