...
License to copy and use this software is granted provided that it is identified as the ??SA Data Security, Inc. MD4 Message-Digest AlgorithmÅEin all material mentioning or referencing this software or this function.
License is also granted to make and use derivative works provided that such works are identified as ??erived from the RSA Data Security, Inc. MD4 Message-Digest AlgorithmÅEin all material mentioning or referencing the derived work.
RSA Data Security, Inc. makes no representations concerning either the merchantability of this software or the suitability of this software for any particular purpose. It is provided ??s isÅEwithout express or implied warranty of any kind.
