...
//===========================================================================
// returns 1 if the bot is against a ladder
//
// Parameter:			-
// Returns:				-
// Changes Globals:		-
...
//===========================================================================
// returns 1 if the bot is on the ground
//
// Parameter:			-
// Returns:				-
// Changes Globals:		-
...
int AAS_OnGround(vec3_t origin, int presencetype, int passent)
{
	...
	if (origin[2] - trace.endpos[2] > 10) return 0;
	//check if the plane isn't too steep
	plane = AAS_PlaneFromNum(trace.planenum);
	if (DotProduct(plane->normal, up) < aassettings.phys_maxsteepness) return 0;
	//the bot is on the ground
	return 1;
} //end of the function AAS_OnGround
//===========================================================================
// returns 1 if a bot at the given position is swimming
//
// Parameter:				-
// Returns:					-
// Changes Globals:		-
...
int AAS_Swimming(vec3_t origin)
{
	...
	testorg[2] -= 2;
	if (AAS_PointContents(testorg) & (CONTENTS_LAVA|CONTENTS_SLIME|CONTENTS_WATER)) return 1;
	return 0;
...
void AAS_JumpReachRunStart(aas_reachability_t *reach, vec3_t runstart)
{
	...
	//
	AAS_PredictClientMovement(&move, -1, start, PRESENCE_NORMAL, 1,
								vec3_origin, cmdmove, 1, 2, 0.1f,
								SE_ENTERWATER|SE_ENTERSLIME|SE_ENTERLAVA|
								SE_HITGROUNDDAMAGE|SE_GAP, 0, 0);
...
int AAS_ClipToBBox(aas_trace_t *trace, vec3_t start, vec3_t end, int presencetype, vec3_t mins, vec3_t maxs)
{
	...
	for (i = 0; i < 3; i++)
	{
		if (start[i] < absmins[i] && end[i] < absmins[i]) return 0;
		if (start[i] > absmaxs[i] && end[i] > absmaxs[i]) return 0;
	} //end for
...
void AAS_TestMovementPrediction(int entnum, vec3_t origin, vec3_t dir)
{
	...
	AAS_PredictClientMovement(&move, entnum, origin, PRESENCE_NORMAL, 1,
									velocity, cmdmove, 13, 13, 0.1f, SE_HITGROUND, 0, 1);//SE_LEAVEGROUND);
...
// Returns:				0 if too high or too far from start to end
// Changes Globals:		-
//===========================================================================
