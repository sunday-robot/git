...
#include "../botlib_include/be_ai_weap.h"
#include "../botlib_include/be_ai_chat.h"
#include "../botlib_include/be_ai_char.h"
#include "../botlib_include/be_ai_gen.h"
...
//	AAS_ClearShownDebugLines();
	...
	//newarea = BotReachabilityArea(origin, 1);
	if (newarea != area)
	{
