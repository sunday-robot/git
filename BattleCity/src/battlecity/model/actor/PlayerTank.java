...
public class PlayerTank extends Tank {
	...
	/** スコア */
	int score; // FIXME:これはプレイヤーの戦車のプロパティではなく、プレイヤーのプロパティ
	...
	public int leftTankCount; // FIXME:これはプレイヤーの戦車のプロパティではなく、プレイヤーのプロパティ
	 ...
	 *            GameModel
	 */
	public PlayerTank(StageGameMaster gameGamen) {
	...
	protected final boolean moveSub() {
		 ...
		 * 
		 * // FIXME:
		 * 以下のアイテムを取得する処理などは、PlayerTankクラスではなく、ゲームを進行させ、各種判定を行うマネージャの仕事とすべきだ 。
